<template>
  <div class="feature-containner">
    <div class="feature-header">
      <span>车型特征录入</span>
      <el-button v-if="feature.id == ''" class="btn-reset" size="small" type="primary" @click="handleReset">重置</el-button>
    </div>
    <el-collapse ref="featureDiv" v-model="activeNames" @change="handleGroup">
      <div class="feature-hotindex">
        <span>热门指数：</span>
        <el-rate v-model="feature.hotindex"></el-rate>
      </div>
      <el-collapse-item name="1" title="品牌类型">
        ...
        <div class="feature-item">
          <span>车型：</span>
          <el-select v-model="feature.type" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange('type')" v-bind:class="{'error':rules.type}" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>车标框形：</span>
          <el-select v-model="feature.chebiaokuangxing" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>车标位置：</span>
          <el-select v-model="feature.chebiaoweizhi" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
      ...
      <el-collapse-item name="2" title="车身前面">
        <div class="feature-item">
          <span>格栅结构：</span>
          <el-select v-model="feature.geshanjiegou" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>上格栅形：</span>
          <el-select v-model="feature.shanggeshanxing" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>格栅前雾：</span>
          <el-select v-model="feature.geshanqianwu" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>格栅前照：</span>
          <el-select v-model="feature.geshanqianzhao" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>前包护板：</span>
          <el-select v-model="feature.qianbaohuban" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>新能源标：</span>
          <el-select v-model="feature.frontxinnengyuanbiao" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
      ...
      <el-collapse-item name="3" title="车身侧面">
        <div class="feature-item">
          <span>B柱颜色：</span>
          <el-select v-model="feature.bzhuyanse" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>后窗小窗：</span>
          <el-select v-model="feature.houchuangxiaochuang" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>后窗下沿：</span>
          <el-select v-model="feature.houchuangxiayan" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>门把手：</span>
          <el-select v-model="feature.menbashou" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>门把手颜色：</span>
          <el-select v-model="feature.menbashouyanse" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>门线圈：</span>
          <el-select v-model="feature.menxianwei" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>油箱盖位：</span>
          <el-select v-model="feature.youxianggaiwei" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>轮毂轮辐：</span>
          <el-select v-model="feature.lungulunfu" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>腮饰：</span>
          <el-select v-model="feature.saishi" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>侧窗框：</span>
          <el-select v-model="feature.chechuangneikuang" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
      ...
      <el-collapse-item name="4" title="车身后面">
        <div class="feature-item">
          <span>后窗框形：</span>
          <el-select v-model="feature.houchuangkuangxing" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>尾灯位置：</span>
          <el-select v-model="feature.weidengweizhi" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>尾灯形状：</span>
          <el-select v-model="feature.weidengxingzhuang" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>号牌框眉：</span>
          <el-select v-model="feature.haopaikuangmei" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>号牌框形：</span>
          <el-select v-model="feature.haopaikuangxing" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>号牌位置：</span>
          <el-select v-model="feature.haopaiweizhi" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>高位制动灯：</span>
          <el-select v-model="feature.gaoweizhidongdeng" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>后防雾灯：</span>
          <el-select v-model="feature.houfangwudeng" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>排气口位：</span>
          <el-select v-model="feature.paiqikouwei" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>外挂备胎：</span>
          <el-select v-model="feature.waiguabeitai" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>新能源标：</span>
          <el-select v-model="feature.backxinnengyuanbiao" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
      ...
      <el-collapse-item ref="item5" name="5" title="车身顶部">
        <div class="feature-item">
          <span>顶密封条：</span>
          <el-select v-model="feature.dingmifengtiao" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>尾翼扰流：</span>
          <el-select v-model="feature.weiyiraoliu" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>行李支架：</span>
          <el-select v-model="feature.xinglizhijia" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
        ...
        <div class="feature-item">
          <span>背鯺天线：</span>
          <el-select v-model="feature.beijitianxian" placeholder="请选择" class="feature-selector-inner" v-on:change="handleChange" :disabled="!canEditFeature">
...
export default {
  ...
  components: {},
  props: ["featuresInfo", "rules", "canEditFeature"],
  watch: {
    featuresInfo: {
  ...
  methods: {
    ...
    handleChange(name) {
      console.log("feature selectd:" + name);
      if (name === "brand") {
        this.clearSeires();
      ...
      if (name === "series") {
        this.clearYear();
        getModelYearsBySeriesId({ seriesId: this.feature.series }).then(res => {
          if (res.success) {
      ...
      if (name === "modelyear") {
        this.clearModel();
        getModelsByModelYearId({ modelyearId: this.feature.modelyear }).then(
          res => {
            this.$set(this.featureSource, "modelItems", res.data);
          }
        );
      }
      this.$emit("feature:changed", this.feature, name);
    },
    handleReset() {
