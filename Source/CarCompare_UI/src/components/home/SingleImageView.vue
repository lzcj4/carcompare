<template>
  <div class="img-upload img-view">
    ...
    <el-upload :disabled="true" ref="dd" v-show="imageUrl == null || imageUrl.url == ''" class="img-upload" action="/api/files" @click="" :auto-upload=false :on-change="handleSelected" list-type="picture-card" :show-file-list="false" :objectBind="index" accept="image/png, image/jpeg" >
